...
VALUES 
    (1, 1, 'Flight to NYC', '2024-03-01 08:00:00', 'transportation', 'Round trip flight from SFO to JFK', 250.00, 'https://example.com/flight'),
    (2, 1, 'Hotel stay', '2024-03-01 15:00:00', 'accommodation', '4 nights at Marriott Times Square', 300.00, 'https://example.com/hotel'),
    (3, 1, 'Client dinner', '2024-03-02 19:00:00', 'activity', 'Dinner meeting with potential client', 45.00, NULL);

...
VALUES 
    (1, 1, 'Business Trip to New York', '2025-06-02 00:00:00', '2025-06-05 00:00:00', 'Annual business review meeting', 595.00),
    (2, 1, 'Conference in San Francisco', '2025-05-09 00:00:00', '2025-05-18 00:00:00', 'Tech conference and networking', 825.00),
...
VALUES 
    (1, 1, 'Flight to NYC', '2025-06-01 08:00:00', '2025-06-01 08:00:00', 'transportation', 'Round trip flight from SFO to JFK', 250.00, 'https://example.com/flight'),
    (2, 1, 'Hotel stay', '2025-06-01 15:00:00', '2025-06-01 15:00:00', 'accommodation', '4 nights at Marriott Times Square', 300.00, 'https://example.com/hotel'),
    (3, 1, 'Client dinner', '2025-06-02 19:00:00', '2025-06-02 19:00:00', 'activity', 'Dinner meeting with potential client', 45.00, NULL);

-- Insert items for the second trip
INSERT INTO items (id, trip_id, title, start_date, end_date, item_type, description, cost, web_link)
VALUES 
    (4, 2, 'Flight to SFO', '2025-05-09 10:00:00', '2025-05-09 10:00:00', 'transportation', 'Round trip flight from JFK to SFO', 350.00, 'https://example.com/flight'),
    (5, 2, 'Conference hotel', '2025-05-09 15:00:00', '2025-05-09 15:00:00', 'accommodation', '5 nights at Hilton Union Square', 400.00, 'https://example.com/hotel'),
    (6, 2, 'Conference registration', '2025-05-09 09:00:00', '2025-05-09 09:00:00', 'activity', 'Full conference pass', 75.00, 'https://example.com/conference'),
